            ...
            <div className="container-fluid">
                <div className='row p-md-5 p-4'>
                    <div className='col-6 col-md-3 mb-4 mb-md-0 d-flex flex-column'>
                        <h3 className="mb-1 fw-bold text-red">Menu</h3>
                        <ul className='list-unstyled pt-2 text-blue fw-bold'>
                    ...
                    <div className='col-6 col-md-3 mb-4 mb-md-0 d-flex flex-column'>
                        <h3 className="mb-1 fw-bold text-red">Social</h3>
                        <ul className='list-unstyled pt-2 text-blue fw-bold'>
                    ...
                    <div className='col-12 col-md-6 d-flex justify-content-center justify-content-md-end align-items-center'>
                        <div className="text-center" style={{ maxWidth: '300px' }}>
                            <img className="img-fluid" src="/StarDISK-final-logo.png" alt="StarDisk Logo" />
                            <h5 className='pt-3 fw-bold text-red'>
